...
<!--    <div class="banner">-->
        ...
        <div class="aboutUsBox">
            ...
            <div class="about2">
                ...
                <br>
                <p class="about3">We strive to offer the best possible service at the most affordable prices <br> so you and your loved ones 
        ...
        <p class="about1">We offer face-painting, balloon twisting, henna and glitter tattoos, mascots, and photography (booths and/or photographers)</p>
        <br>
        <br>
...
<!--        <p class="about1">Email: JJEntertainment@hotmail.com / <a href="landing?page=contact">Contact Page</a></p><br><br>-->
        <p class="about1"><a href="landing?page=contact">Contact Page</a></p><br><br>
